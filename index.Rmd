...
w_num <- "11"
w_units <- c("u5-d01-text-analysis", "u5-d02-comparing-texts",
...
w7 <- c("u2-d18-web-scrape", "u2-d19-top-250-imdb", "u2-d20-considerations")
w8 <- c("u4-d01-language-of-models", "u4-d02-fitting-interpreting-models",
        "u4-d03-modeling-nonlinear-relationships", "u4-d04-model-multiple-predictors",
        "u4-d05-more-model-multiple-predictors")
w9 <- c("u4-d06-logistic-reg", "u4-d07-prediction-overfitting",
        "u4-d08-feature-engineering")
w10 <- c("u4-d09-cross-validation", "u4-d10-quantify-uncertainty",
        "u4-d11-bootstrap", "u4-d12-hypothesis-testing")
w11 <- c("u5-d01-text-analysis", "u5-d02-comparing-texts",
        "u5-d04-machine-learning")
bind_rows(
